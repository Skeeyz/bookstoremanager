...
//	}
	...
	public QL_KhuyenMaiGUI() {
		...
		panel.setBounds(10, 63, 1074, 638);
		...
		panel_2.setBounds(10, 10, 1054, 123);
		panel.add(panel_2);
		...
		lblNewLabel_1_2.setBounds(415, 25, 77, 30);
		panel_2.add(lblNewLabel_1_2);
		
		JLabel lblNewLabel_1_2_1 = new JLabel("Ngày KT:");
		lblNewLabel_1_2_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_1_2_1.setBounds(415, 78, 77, 30);
		...
		date_BĐ.setBounds(502, 10, 162, 45);
		panel_2.add(date_BĐ);
		...
		date_KT.setBounds(502, 65, 162, 43);
		panel_2.add(date_KT);
		...
		panel_3.setBounds(10, 144, 1054, 98);
		panel.add(panel_3);
		...
		btn_ThemKM.setBounds(249, 33, 100, 32);
		...
		btn_SuaKM.setBounds(387, 33, 100, 32);
		...
		btn_XoaKM.setBounds(553, 33, 100, 32);
		...
		btn_Clear.setBounds(689, 33, 100, 32);
		...
		panel_4.setBounds(10, 288, 1054, 338);
		panel.add(panel_4);
		panel_4.setLayout(null);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 24, 1034, 303);
		...
		tbl_KM.setModel(new DefaultTableModel(
			new Object[][] {},
			new String[] {
				"Mã Khuyến Mãi", "Tên Khuyến Mãi", "Ngày bắt đầu", "Ngày kết thúc","Phần trăm giảm", "Điều kiện", "Trạng thái"
			}
		));
...
//		scrollPane_1.setViewportView(tbl_CTKM);
	...
	private void loadingKhuyenMai() {
        ...
        for (KhuyenMai km : dskm) {
            ...
            vec.add(km.getPhanTramGiam()+"");
            vec.add(km.getDieuKien()+"");
            Date now = new Date();
	...
	private void themKhuyenMai() {
		...
		boolean flag = KMBUS.themKhuyenMai(
				...
				date_BĐ.getDate(),
				date_KT.getDate(),
                                txt_phanTram.getText(),
                                txt_dieuKien.getText());
		if(flag) {
			KMBUS.docDanhSach();
			loadingKhuyenMai();
		}
