...
//	}
	 ...
	 * Create the frame.
	 */
	public DLG_ChonKhachHang(QL_BanHang parent) {
	...
	private void chonKhachHang() {
		parent.setKhachHang(String.valueOf(KHTimThay.getMaKH()),KHTimThay.getHoKH(),KHTimThay.getTenKH(),KHTimThay.getGioitinh());
	}
}
